...
def tm_1_1(state):
    yield [ ('t_a', 3, 4), ('t_a', 4, 5) ]


def tm_1_2(state):
    yield [ ('t_a', 3, 4), ('t_a', 4, 5), ('t_a', 5, 6) ]


def tm_1_3(state):
    yield [ ('t_a', 2, 4), ('t_a', 4, 5), ('t_a', 5, 6) ]
...
def test_sample_7():
    ...
    # REMOVED AS REPLAN CURRENTLY NOT FUNCTIONAL
