...
class ButtonMazeRigidRelations:
    def __init__(
        ...
        self.opens: Dict[ Button, Tuple[ Connection ] ] = opened_by
...
class ButtonMazeReferenceChronicle( ReferenceChronicle ):
    def __init__(
...
def press_button(
    ...
    if CI.verify_object_assertion_list(
        ...
        temporal_constraint_lst: List[ TemporalConstraint ] = [
            ...
            (t_open, "==", t_close_start, open_time),
        ]
        temporal_restoration_tup: TemporalRestorationTuple = ([ ], [ ], [ ])
        # attempt to add all
        new_reference_chronicle = reference_chronicle.copy()
...
def stabilize(
    ...
    locations = value_chronicle.domain_objects[ "locations" ]
    rigid_relations: ButtonMazeRigidRelations = value_chronicle.rigid_relations
    patient_loc: Location = rigid_relations.button_at[ patient ]
    if CI.verify_object_assertion_list(
            reference_chronicle,
            value_chronicle,
            [
...
temporal_action_lst: List[ TemporalAction ] = [ move, press_button ]
