#!/usr/bin/env python
"""
File Description: Openstacks testing file. Run this file to create Openstacks test data.
"""
...
import os
from examples.openstacks.openstacks_example import init_openstacks
import numpy as np
import time
...
def main():
    ...
    new_cpu_time = np.genfromtxt( "new_openstacks_cpu_time.csv", delimiter="," )
    new_action_count = np.genfromtxt( "new_openstacks_action_count.csv", delimiter="," )
    old_iteration_count = np.genfromtxt( "old_openstacks_iteration_count.csv", delimiter="," )
    old_cpu_time = np.genfromtxt( "old_openstacks_cpu_time.csv", delimiter="," )
    old_action_count = np.genfromtxt( "old_openstacks_action_count.csv", delimiter="," )
